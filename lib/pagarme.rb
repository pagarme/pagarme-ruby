...
require File.join(File.dirname(__FILE__), '.', 'pagarme/customer')
require File.join(File.dirname(__FILE__), '.', 'pagarme/phone')
require File.join(File.dirname(__FILE__), '.', 'pagarme/address')
